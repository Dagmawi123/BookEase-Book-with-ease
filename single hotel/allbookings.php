...
{
	echo "<tr><td>{$row['reservedid']}</td>
    <td>{$row['arrival']}</td>
    <td>{$row['departure']}</td>
    <td>{$row['userid']}</td>
    <td>{$row['roomid']}</td>
    <td>{$row['bookdate']}</td>"."
	<td><a href='deleteReserve.php?id={$row['roomid']}' style='color:red; text-decoration:none;'>Delete Reservation</a></td>";
}
echo "</table>";
?>
</div>
