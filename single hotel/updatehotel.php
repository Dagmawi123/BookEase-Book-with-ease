...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">   
  Room Type ID:&emsp;&emsp;&emsp;&emsp;<input  required type="text" name="roomtypeid" placeholder="eg:12">
  <br><br>
  Hotel Name:&emsp;&emsp;&nbsp;<input  required type="text" name="hotelname" placeholder="eg:Itege Taiytu Hotel">
   <br><br>&emsp;&emsp;
...
if(isset($_POST['save']))
{
  ...
  $q1="UPDATE roomtype set hotel_name='$hotelname'where roomtypeid='$roomtypeid'";
